...
# === Airport Group Definitions ===
domestic_airports = {"EDI", "GLA", "BHD", "MAN", "ABZ", "INV", "NCL", "JER"}
short_haul_airports = {
    "AMS", "BCN", "CDG", "FCO", "GVA", "CPH", "BRU", "LIN", "ZRH", "DUB", "MAD",
    "BER", "PRG", "VIE", "MUC", "LIS", "ATH", "RAK", "TLS", "BUD", "WAW", "STR",
    "DUS", "AGP", "NAP", "PMI", "LCA", "OSL", "GOT", "VCE", "TFS", "PSA", "FLR",
    "BLL", "IBZ", "HAJ", "CGN", "LUX"
}
