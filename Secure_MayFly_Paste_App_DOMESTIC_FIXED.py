...
# Define domestic routes (UK & Ireland)
domestic_routes = ['LHRABZ', 'LHRBHD', 'LHREDI', 'LHRGLA', 'LHRINV', 'LHRJER', 'LHRMAN', 'LHRNCL', 'LHRLCY', 'LHRLGW', 'LHREXT', 'LHRBRS', 'LHRLBA', 'LHRDSA', 'LHRIOM', 'LHRNQY', 'LHRDUB', 'LHRORK', 'LHRSNN', 'LHRBFS']
